	...
	<div class="app">
		...
		<ui5-dialog header-text="Edit Todo" ref="editDialog">
			...
			<div class="dialog-footer" data-ui5-slot="footer">
				<ui5-button class="dialog-footer-btn--cancel" design="Transparent"
					@click="cancelEdits">Cancel</ui5-button>
				<ui5-button class="dialog-footer-btn--save" design="Emphasized" @click="saveEdits">Save</ui5-button>
			</div>
		</ui5-dialog>

		<ui5-popover ref="theme-settings-popover" class="app-bar-theming-popover" placement="Bottom"
			horizontal-align="End" header-text="Theme">
		...
		<ui5-popover ref="profile-popover" id="profile-pop" class="app-bar-profile-popover" placement="Bottom"
			...
			<div class="profile-settings-list">
				<ui5-list selection-mode="Single" separators="None" @item-click="handleProfileSettingsSelect"
		...
		<ui5-dialog id="settings-dialog" ref="settings-dialog" header-text="Profile Settings" :draggable="true">
			<div>
		...
		<ui5-dialog id="help-dialog" ref="help-dialog">
	...
	methods: {
		...
		handleProfileSettingsSelect: function (event) {
			...
			if (selectedKey === 'settings') {
				this.$refs['settings-dialog'].open = true;
			} else if (selectedKey === 'help') {
				this.$refs['help-dialog'].open = true;
			}
		},
		...
		handleSettingsDialogCloseButtonClick: function () {
			this.$refs['settings-dialog'].open = false;
		},
		handleHelpDialogCloseButtonClick: function () {
			this.$refs['help-dialog'].open = false;
		},
		handleAdd: function () {
